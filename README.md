...
graph TD
    ...
    B --> C[nodes.py: RAG Retrieval & Tailoring]
    C --> D[state.py: Memory Persistence]
    D --> E[edges.py: Conditional Routing]
    E --> F[main.py: Final LaTeX Output]

##Setup & Installation
For end users(Quick Start)
If you just wnat to generate a resume, follow these steps:
